export default function About() {
  return (
    <section
      id="sobre-mim"
      className="px-12 py-8 bg-secondary h-fit min-h-[70vh]  flex flex-col justify-center xl:gap-36  items-center  md:gap-20 md:px-8 lg:px-20 md:flex-row  xl:min-h-[95vh]"
    >
      ...
      <div className="flex items-center justify-center mt-12">
        <img
          src="/about.png"
          alt="profile"
          className="rounded-xl click w-70 md:w-95 xl:w-110"
        />
      </div>
    </section>
  );
